...
// then digunakan apabila setelah axios kita ingin melakukan fungsi lain
// axios put dia akan menimpa data yang lama
// axios patch mengupdate data

/* 
- yang bisa menaruh data kedalam state adalah si reducer, 
artinya data dari react harus diantar ke reducer baru ke state
- ketika sebuah komponen ingin mengambil atau memberikan data harus import atau connect react-redux
*/